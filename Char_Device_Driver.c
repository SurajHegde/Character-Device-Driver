...
{ 
 ...
 if((ret=alloc_chrdev_region(&devno,0,1,"CHARACTER DRIVER"))<0) /*Used to dynamically allocate the major number for the device ,defined in <linux/fs.h>,The device is       
